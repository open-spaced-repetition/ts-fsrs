...
description: Generate or maintain Rspress v2 documentation for a project. Use when creating a new docs site, documenting user-facing work, or maintaining a dedicated Rspress project. If an existing site uses Rspress v1, stop and report that migration is outside this skill.
---
...
- Detect Rspress v1 version markers before documentation work and stop without editing the site.
...
- [Rspress Version Guard](references/rspress-version-guard.md) — detect v1 sites and stop before editing or migrating them.
