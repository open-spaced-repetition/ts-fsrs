...
export default {
  ...
  moduleNameMapper: {
    '^(\\.{1,2}/.*)\\.js$': '$1',
    '^@open-spaced-repetition/binding$': '<rootDir>/dist/index.mjs',
    '^@open-spaced-repetition/binding/index.js$': '<rootDir>/dist/index.mjs',
    '^@open-spaced-repetition/binding/(.*)$': '<rootDir>/dist/$1',
  },
