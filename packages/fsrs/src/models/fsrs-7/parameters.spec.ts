...
const referenceClips = [
  {"input":[-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000,-1000],"expected":[0.0001,0.0001,0.0001,0.0001,1,0.001,0.1,0,0,0.3,0.01,0.1,0,0,1,0,0,0.5,0.001,0.001,0,0,1,0.01,0.01,0.2,0.2,0.01,0.1,0,0.1,0,0,0]},
  ...
  {"input":[5,3,2,1,6.1686,0.6457,3.6807,1.9795,0,1.3826,0.7024,0.5999,0.8146,0.6398,1,1.3207,0.6707,3.8668,0.4416,0.0934,1.8631,0.6162,1.0869,0.1567,0.0801,0.3,0.2,0.1433,0.7145,0,0.5667,0.3734,0.5333,0.3048],"expected":[5,5,5,5,6.1686,0.6457,3.6807,1.9795,0,1.3826,0.7024,0.5999,0.8146,0.6398,1,1.3207,0.6707,3.8668,0.4416,0.0934,1.8631,0.6162,1.0869,0.1567,0.0801,0.3,0.3,0.1433,0.7145,0,0.5667,0.3734,0.5333,0.3048]}
]
...
describe('FSRS-7 parameters', () => {
  ...
  it('uses Rust base2 >= base1, including the range below the benchmark clipper floor of 0.5', () => {
    const weights = [...FSRS7_DEFAULT_WEIGHTS]
    weights[25] = 0.3
    weights[26] = 0.2
    expect(clipFSRS7Parameters(weights)[26]).toBe(0.3)
